...
// for both chains. The channels created are connected to the ibc-account application.
...
// CreateIBCAccountChannels constructs and executes channel handshake messages to create OPEN
// ibc-account channels on chainA and chainB. The function expects the channels to be
// successfully opened otherwise testing will fail.
...
func (coord *Coordinator) ChanOpenInit(
	...
	// NOTE: only creation of a capability for a ibc-account or mock port is supported
