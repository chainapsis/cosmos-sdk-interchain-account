...
func NewDemoApp(
	...
	scopedInterchainAccountKeeper := app.capabilityKeeper.ScopeToModule(ia.ModuleName)
	...
	app.interchainAccountKeeper = ia.NewKeeper(appCodec, keys[ia.StoreKey], cdc, cdc, app.ibcKeeper.ChannelKeeper, &app.ibcKeeper.PortKeeper, app.accountKeeper, scopedInterchainAccountKeeper, app.Router())
	interchainAccountModule := ia.NewAppModule(app.interchainAccountKeeper)

	// Create static IBC router, add transfer route, then set and seal it
	ibcRouter := port.NewRouter()
	ibcRouter.AddRoute(transfer.ModuleName, transferModule)
	ibcRouter.AddRoute(ia.ModuleName, interchainAccountModule)
